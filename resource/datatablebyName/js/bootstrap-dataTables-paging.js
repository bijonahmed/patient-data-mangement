...
$.extend(true, $.fn.dataTable.defaults, {
  "sDom": "<'row'<'col-xs-7 col-lg-12'7><'col-xs-7 col-sm-6 text-right'f>r>t<'row'<'col-xs-3 col-sm-4 col-md-12'i><'col-xl-3 col-sm-8 col-md-4 text-right'p>>",
  ...
  "fnInitComplete": function (oSettings, json) {
    ...
    // Re-arrange the records selection for a form-horizontal layout
     ...
     // thisLengthLabel.addClass('control-label col-xs-12 col-sm-7 col-md-10').attr('for', currentId + '_length_select').css('text-align', 'left');
     // thisLengthSelect.addClass('form-control input-sm').attr('id', currentId + '_length_select');
     // thisLengthSelect.prependTo(thisLength).wrap('<div class="col-xs-12 col-sm-5 col-md-2" />');
      // Re-arrange the search input for a form-horizontal layout
     // thisFilter.addClass('form-group');
     // thisFilterLabel.addClass('control-label col-xs-4 col-sm-3 col-md-7').attr('for', currentId + '_filter_input');
     // thisFilterInput.addClass('form-control input-sm').attr('id', currentId + '_filter_input');
     // thisFilterInput.appendTo(thisFilter).wrap('<div class="col-xs-8 col-sm-9 col-md-5 " />');
    }
  }
});
