...
<script language="javascript" src="<?php echo base_url();?>resource/jquery.printPage.js"></script>
  ...
  $(document).ready(function() {
		...
		var source = '<?php echo base_url();?>welcome/print_preview_haematology'; 								//Refer to any page on your server, external pages are not valid e.g. http://www.google.co.uk
...
<script>
 $(document).ready(function() {
$(".btnPrint").printPage({
url: "<?php echo base_url(); ?>welcome/print_preview_haematology.html",
attr: "href",
message:"Your document is being created Print"
 ...
 <div class="container">
             <center><div class="fontstyleing"><u>Haematology Report</u></div></center>
     <div align="right">
     ...
     <div class="container " style="height: 523px; ">
             <form name="haematology" method="post" action="<?php echo base_url(); ?>data_record/save_haematologyreporting.html">
                ...
                <div class="">
                    ...
                    <div class="row" style="" >
                        ...
                        <div class="col-sm-2 inline">
                            ...
                            <input type="text" name="reciv_date" data-date-format="dd-mm-yyyy" class="form-control" id="reciv_date" placeholder="Please Enter Data" required="1">
                        ...
                        <div class="form-group has-success">
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <div class="col-xs-2">
                                        <input type="text" name="platelete" class="form-control" placeholder="PLT">
                                    </div>
                                    <div class="col-xs-2">
                                        <input type="text" name="wbc" class="form-control" placeholder="WBC">
                                    </div>
                                    <div class="col-xs-2">
                                        <input type="text" name="ce" class="form-control" placeholder="TCE">
                                    </div>
                                    <div class="col-xs-2">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group has-success">
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="col-xs-2">
                                        <input type="text" name="neutrophils" class="form-control" placeholder="Neutrophils">
                                    </div>
                                    <div class="col-xs-2">
                                        <input type="text" name="lymphocytes" class="form-control" placeholder="Lymphocytes">
                                    </div>
                                    <div class="col-xs-2">
                                        <input type="text" name="monocytes" class="form-control" placeholder="Monocytes">
                                    </div>
                                    <div class="col-xs-2">
                                        <input type="text" name="eosinophils" class="form-control" placeholder="Eosinophils">
                                    </div>
                                    <div class="col-xs-2">
                                        <input type="text" name="basophil" class="form-control" placeholder="Basophbils">
                                    </div> <br> <br>

                                    <div class="col-xs-2">
                                        <input type="text" name="parameter_one" class="form-control" placeholder="Blank Parameter" value="">
                                    </div>
                                    ...
                                    <div class="col-xs-2">
                                        <input type="text" name="parameter_two" class="form-control" placeholder="Blank Parameter" value="">
                                    </div>
                                    ...
                                    <div class="col-xs-2">
                                        <input type="text" name="parameter_three" class="form-control" placeholder="Blank Parameter" value="">
                                    </div>
                                    ...
                                    <div class="col-xs-2">
                                        <input type="text" name="mp" class="form-control" placeholder="MP">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group has-success">
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="col-xs-2">
                                        <input type="text" name="hct" class="form-control" placeholder="HCT/PCV">
                                    </div>
                                    <div class="col-xs-2">
                                    ...
                                    <div class="col-xs-2">
                                        <input type="text" name="bt_min" class="form-control" placeholder="BT ">
                                    </div>
                                    <br><br>
                                    <div class="col-xs-2">
                                        <input type="text" name="bt_sec" class="form-control" placeholder="Result">
                                    </div>
                                    <div class="col-xs-2">
                                        <input type="text" name="ct_min" class="form-control" placeholder="CT">
                                    </div>
                                    <div class="col-xs-2">
                                        <input type="text" name="ct_sec" class="form-control" placeholder="Result">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <button type="button" class="btn btn-info btn btnPrint"><i class="icon-print"></i> <span class="glyphicon glyphicon-print"></span>  Printing</button>
                       ...
                       <a href="link"data-toggle="modal" data-target="#dd" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span>&nbsp;PBF</a>
        ...
        <button type="button" class="btn btn-danger"><i class="icon-print"></i> <span class="glyphicon glyphicon-eject"></span>  CLOSE</button>
    </a>
         <!-- Modal -->
...
foreach($haematology_data as $data) {
?>
...
<td>
<a class="link" href="<?php echo base_url();?>data_record/edit_form_haematology/<?php echo $data->haematology_id;?>" onClick="return save();" style="text-decoration:none"><span class="glyphicon glyphicon-edit"></span> Edit</a>
<?php
/*
