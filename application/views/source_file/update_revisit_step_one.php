                    ...
                    <div class="col-md-3">
                        ...
                        <div class="alert alert-info">
                            ...
                            Height<div class="form-group has-success">
                                <input type="text" class="form-control" name="height" value="<?php echo $revisitInfo->height;?>">
                                 <input type="hidden" name="current_date" value="<?php echo date("Y-m-d");?>" required="1" >
                                <br>


                                Weight<div class="form-group has-success">
                                    <input type="text" class="form-control" name="weight" value="<?php echo $revisitInfo->weight;?>" >
                                    <br>

                                    Blood Pressure<div class="form-group has-success">
                                        <input type="text" class="form-control" name="pressure" required="1" value="<?php echo $revisitInfo->pressure;?>" >
                                        <br>
                        ...
                        <div class="alert alert-danger">
                            ...
                            Complaint Group<div class="form-group has-success">
                                ...
                                <select name="cc_group_id" id="cc_group_id" class="form-control input-lg"onChange="complain_groupinfo(this.value);">
                                    <option selected="selected"><?php echo $revisitInfo->complain_group_name;?></option>
<?php
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <textarea class="jqte-test form-control" style="height: 800px;" name="patient_history_info" ><?php echo $revisitInfo->patient_history_info;?></textarea>
