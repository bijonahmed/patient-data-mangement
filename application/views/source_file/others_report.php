...
<link rel="stylesheet" href="<?php echo base_url(); ?>resource/themes/base/jquery.ui.all.css">
        ...
        <script>
            $(document).ready(function() {
                ...
                var source = '<?php echo base_url(); ?>welcome/print_preview_others'; 								//Refer to any page on your server, external pages are not valid e.g. http://www.google.co.uk
        ...
        <script>
            $(document).ready(function() {
                $(".btnPrint").printPage({
                    url: "<?php echo base_url(); ?>welcome/print_preview_others.html",
                    attr: "href",
  ...
  <style>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="container">
                ...
                <form name="haematology" method="post" action="<?php echo base_url(); ?>data_record/save_others_report.html">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Search Others Report</h4>
                    </div>
                        ...
                        <div class="">
                            ...
                            <div class="form-group has-success">
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                    ...
                                    <tbody>
                                        <?php
                                        foreach ($others_report_data as $data) {
                                            ?>
    ...
    echo $manual_pid;?></span></td>
                                                ...
                                                <td>
                                                    <a class="tooltips link" href="#" onClick="return save_();" style="text-decoration:none"><span>Edit Report</span> Edit</a>
                                                    <?php
                                                    /*
