...
<html lang="en">
    <head>
        ...
        <title>Cytopathology Report</title>
...
<link rel="stylesheet" href="<?php echo base_url(); ?>resource/themes/base/jquery.ui.all.css">
        ...
        <script>
            $(document).ready(function() {
                ...
                var source = '<?php echo base_url(); ?>welcome/print_preview_cytopathology'; 								//Refer to any page on your server, external pages are not valid e.g. http://www.google.co.uk
        ...
        <script>
            $(document).ready(function() {
                $(".btnPrint").printPage({
                    url: "<?php echo base_url(); ?>welcome/print_preview_cytopathology.html",
                    attr: "href",
  ...
  <style>
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <div class="container">
                              <center><div class="fontstyleing"><u>Cytopathology Report</u></div></center>
          
                <form name="haematology" method="post" action="<?php echo base_url(); ?>data_record/save_cytopathology_report.html">
                    <div class="form-group has-success">
                        ...
                        <div class="row" >
                            ...
                            <div class="container">
                                <font color="#FF0000">
                                <?php
                                $message = $this->session->userdata('save_messages_cytopathology');
                                //echo $message;
                                if (isset($message)) {
                                    echo $message;
                                    $this->session->unset_userdata('save_messages_cytopathology');
                                }
                                ?>
                                </font> 
                                <div class="form-group has-success">
...
?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Search Cytopathology</h4>
                    </div>
                        ...
                        <div class="">
                            ...
                            <div class="form-group has-success">
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                    ...
                                    <tbody>
                                        <?php
                                        foreach ($cytopathology_report as $data) {
                                            ?>
    ...
    echo $manual_pid;?></span></td>
                                                ...
                                                <td>
                                                    <a class="tooltips link" href="<?php echo base_url(); ?>data_record/edit_form_cytopathology_report/<?php echo $data->cytopathology_id; ?>" onClick="return save_();" style="text-decoration:none"><span>Edit Report</span> Edit</a>
                                                    <?php
                                                    /*
