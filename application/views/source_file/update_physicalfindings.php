...
// foreach($patientComplain as $valueComplain){
            ...
            <div class="form-group has-success">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="#home" data-toggle="tab">Phys. Finds.</a></li>
                            ...
                            <div class="col-md-10">
                                <div class="">
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <!-- Tab panes -->
                                        <form name="myform" method="post" action="<?php echo base_url(); ?>data_record/update_patieint_history_info_by_physical_findings.html">
                                                ...
                                                <div class="tab-pane active" id="home">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group has-success">
                                                            <div class="row">
                                                                <div class="col-xs-2">
                                                                    <input type="text" class="form-control" name="height" placeholder="Height" value="<?php echo $physicalFindings->height;?>">
                                                                </div>
                                                                <div class="col-xs-2">
                                                                    <input type="text" class="form-control" name="weight" placeholder="Weight" value="<?php echo $physicalFindings->weight;?>">
                                                                </div>
                                                                <div class="col-xs-2">
                                                                    <input type="text" class="form-control" name="presasure" placeholder="Preasure" value="<?php echo $physicalFindings->presasure;?>">
                                                                    <input type="hidden" class="form-control" name="physical_examination_id" value="<?php echo $physicalFindings->physical_examination_id;?>">
                                                                </div>

                                                                <div class="col-xs-2">
                                                                    <input type="text" class="form-control" name="general_examination" placeholder="General Examination" value="<?php echo $physicalFindings->general_examination;?>">
                                                                </div>
                                                                <div class="col-xs-2">
                                                                    <input type="text" class="form-control" name="systemic_examination" placeholder="Systemic Examination" value="<?php echo $physicalFindings->systemic_examination;?>">
                                                                </div>
                                                                <div class="col-xs-2">
                                                                   <center><button class="btn btn-primary" onClick="return save()"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Update</button></center> 
                                                                </div>
                                                ...
                                                <div class="tab-pane active" id="home">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="form-group has-success">
                                                                <select name="familyhistory" class="form-control" id="familyhistory" onchange="if (this.selectedIndex == 2) {
