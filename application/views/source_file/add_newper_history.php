...
?></font>
                ...
                <div class="col-md-4">
                    <div class="">
                        <form name="employee" method="post" action="<?php echo base_url(); ?>data_record/save_personalHistory_info.html">
                            Add Personal History <div class="form-group has-success">
                                <label class="control-label" for="inputSuccess1"></label>
                                <input type="text" class="form-control" name="personal_history_name" id="dose_type"required="1" ><br>
 ...
 <center>
                            <a href="<?php echo base_url(); ?>welcome/viewpesonalhistoryInfo.html">
