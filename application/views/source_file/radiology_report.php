...
<script>
    $(document).ready(function() {
        ...
        var source = '<?php echo base_url(); ?>welcome/print_preview_radiology'; 								//Refer to any page on your server, external pages are not valid e.g. http://www.google.co.uk
...
<script>
    $(document).ready(function() {
        $(".btnPrint").printPage({
            url: "<?php echo base_url(); ?>welcome/print_preview_radiology.html",
            attr: "href",
...
<div class="container">
        ...
        <div class="container ">
            <center><div class="fontstyleing"><u>Radiology Report</u></div></center>
            <br>
            <form name="haematology" method="post" action="<?php echo base_url(); ?>data_record/save_radiology_report.html">
                    ...
                    <div class="">
                        ...
                        <div class="row" style="" >
                            ...
                            <div class="col-xs-2">
                                ...
                                <input type="text" name="reciv_date" data-date-format="dd-mm-yyyy" class="form-control" id="reciv_date" placeholder="Reci.Date">
                            </div>
                        ...
                        <div class="row" >
                            ...
                            <div class="container">
                                <font color="#FF0000">
                                <?php
                                $message = $this->session->userdata('save_radiology_messages');
                                //echo $message;
                                if (isset($message)) {
                                    echo $message;
                                    $this->session->unset_userdata('save_radiology_messages');
                                }
                                ?>
                                </font> 
                                <div class="form-group has-success">
                                ...
                                <tbody>
                                    ...
                                    foreach ($radiology_data as $data) {
                                        ...
                                        <tr class="">
                                            ...
                                            <td>
                                                <a class="tooltips link" href="<?php echo base_url(); ?>data_record/edit_form_radiology_report/<?php echo $data->radiology_id; ?>" onClick="return save();" style="text-decoration:none"><span>Edit Radiology Report</span> Edit</a>
                                                <?php
                                                /*
