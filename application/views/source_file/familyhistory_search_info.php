...
<body>
    ...
    <div class="">
        <div class="">
            <div class="tabbable tabs-left" style="margin-left: 40px;">
                <ul class="nav nav-tabs">
                    ...
                    <li  class="active"><a href="<?php echo base_url(); ?>welcome/patient_find_information_by_remarks.html" data-toggle="_tab"><div class="glyphicon glyphicon-search"></div>&nbsp;Family History</a></li>
        ...
        <div class="col-md-8">
            <h3>Find Patient Information <font color="red"><strong>[Family History ]</strong></font></h3>
            <hr>
            <div class="">
                <form name="conditional_report" class="" method="post" action="<?php echo base_url(); ?>welcome/family_history_search_info.html" target="_top">
                    <div class="form-group has-success">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <input type="text" class="form-control" data-date-format="" id="starting_date_family_history" name="starting_date_family_history" required="1" placeholder="From Date">

                            </div>
                            <div class="col-md-2">
                                <input type="text" class="form-control" data-date-format="" id="ending_date_family_history"name="ending_date_family_history" required="1" placeholder="Ending Date">
                            </div>
                            <div class="col-md-1">
