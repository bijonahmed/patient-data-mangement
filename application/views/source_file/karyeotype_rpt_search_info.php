...
<html lang="en">
    ...
    <body>
        ...
        <div class="">
            <div class="">
                <div class="tabbable tabs-left" style="margin-left: 40px;">
                    <ul class="nav nav-tabs">
                        ...
                        <li  class="active"><a href="#" data-toggle="_tab"><div class="glyphicon glyphicon-search"></div>&nbsp;Karyotype</a></li>
            ...
            <div class="">
                ...
                <h3>Find Patient Investigation <font color="red"><strong>[Karyotype]</strong></font></h3>
                <hr>
                <div id="">
                    <div class="form-group has-warning">
                        <form class="form-inline" name="p_id" method="post" action="<?php echo base_url(); ?>welcome/patient_find_investigation_karyotype.html">
                            <input type="text" class="form-control" name="manual_pid" placeholder="Patient ID" id="TBox0" autofocus="">
                            <input type="text" class="form-control" data-date-format="" id="starting_date" name="starting_date_karyotype" required="1" placeholder="From Date">
                            <input type="text" class="form-control" data-date-format="" id="ending_date" name="ending_date_karyotype" required="1" placeholder="Ending Date">
 ...
 <?php
                        if ($karyotype_rpt_searching != null) {
                            ?>
                            ...
                            <div id="printablediv" style="width: 100%; background-color: none; height: auto">
                                <div align="center">
                                    <strong>Karyotype Reporting Statement<BR><font color="red"></font> </strong>
                                ...
                                <div id="dvData">
                                    ...
                                    <?php
                                    $x = 1;
                                    foreach ($karyotype_rpt_searching as $data) {
                                        ?>
