...
<th width="10">Action</th>
                            ...
                            <tbody>
                                <?php
                                foreach ($view_echo_report as $data) {
                                    ?>
...
<td>
                                            ...
                                            <a class="link" href="<?php echo base_url();?>data_record/edit_form_haematology/<?php echo $data->echo_id;?>" onClick="return save();" style="text-decoration:none"><span class="glyphicon glyphicon-edit"></span> Edit</a>
