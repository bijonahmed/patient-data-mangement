    ...
    <body>
        ...
        <div class="">
            <div class="">
                <div class="tabbable tabs-left" style="margin-left: 40px;">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="<?php echo base_url(); ?>welcome/patient_find_investigation_histopathology.html" data-toggle="_tab"><div class="glyphicon glyphicon-search"></div>&nbsp;Histopathology</a></li>
            ...
            <div class="">
                ...
                <h3>Find Patient Investigation <font color="red"><strong>[Histopathology]</strong></font></h3>
                <hr>
                <div id="">
                    <div class="form-group has-warning">
                        <form class="form-inline" name="p_id" method="post" action="<?php echo base_url(); ?>welcome/patient_find_investigation_histopathology.html">
                            <input type="text" class="form-control" name="manual_pid" placeholder="Patient ID" id="mpid" autofocus="">
                            <input type="text" class="form-control" data-date-format="" id="starting_date" name="starting_date_histopathology" required="1" placeholder="From Date">
                            <input type="text" class="form-control" data-date-format="" id="ending_date"name="ending_date_histopathology" required="1" placeholder="Ending Date">
                    ...
                    <div class="form-group has-success">
                        ...
                        <?php
                        if ($histopathology_rpt_searching != null) {
                            ?>
                            ...
                            <div id="printablediv" style="width: 100%; background-color: none; height: auto">
                                <div align="center">
                                    <strong>Histopathology Report Statement<BR><font color="red"></font> </strong>
                                ...
                                <div id="dvData">
                                    ...
                                    <?php
                                    $x = 1;
                                    foreach ($histopathology_rpt_searching as $data) {
                                        ?>
                                        ...
                                        <div id="printablediv" style="width: 100%; background-color: none; height: auto">
                                            ...
                                            <div id="dvData">
                                                ...
                                                //foreach ($histopathology_rpt_searching as $data) {
                                                    ...
                                                    <hr>
                                                    <strong><font color="#000000"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Patient ID: 
                                                            <?php
                                                    ...
                                                    <p><div align="left"><?php echo $data->report_description; ?></div></p>
