...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="">
                        <form name="employee" method="post" action="<?php echo base_url(); ?>data_record/save_patient_advice_info.html">
 ...
 <center>
                            <a href="<?php echo base_url(); ?>welcome/viewpatientadviceInfo.html">
