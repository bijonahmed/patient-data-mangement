...
<body>
    ...
    <div class="">
        <div class="">
            <div class="tabbable tabs-left" style="margin-left: 40px;">
                <ul class="nav nav-tabs">
                    ...
                    <li  class="active"><a href="#" data-toggle="tab"><div class="glyphicon glyphicon-search"></div>&nbsp;Diagnosis</a></li>
        ...
        <div class="col-md-8">
            <h3>Find Patient Information <font color="red"><strong>[Find Diagnosis]</strong></font></h3>
            <hr>
            <div class="">
                <form name="conditional_report" class="" method="post" action="<?php echo base_url(); ?>welcome/diagnosis_info.html" target="_top">
                    <div class="form-group has-success">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <input type="text" class="form-control" data-date-format="" id="starting_date_diagnosis" name="starting_date_diagnosis" required="1" placeholder="From Date">
                            </div>
                            <div class="col-md-2">
                                <input type="text" class="form-control" data-date-format="" id="ending_date_diagnosis"name="ending_date_diagnosis" required="1" placeholder="To Date">
                            </div>
                            <div class="col-md-1">
                ...
                if ($diagnosisinfo != null) {
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-hover tableradius" id="example">
                        ...
                        <thead>
                            ...
                            <strong> <strong>List OF Diagnosis<br><font color="red"><?php if (isset($diagnosis_information_byPT)) echo $diagnosis_information_byPT; ?></font> </strong>
                                <br>From <?php echo $date_from; ?> To <?php echo $date_to; ?></strong>
