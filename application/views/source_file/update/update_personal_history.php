...
<ul class="nav nav-tabs">
  ...
  <li class="active"><a href="#home" data-toggle="tab">Update Personal History</a></li>
...
<form name="step_one" method="post" action="<?php echo base_url(); ?>data_record/save_patieint_history_info_by_personalHistory_by_update.html">
...
<a class="" href="<?php echo base_url(); ?>data_record/delete_personalHistoryName_update/<?php echo $data->personal_histor_id; ?>" onClick="return delete_data();" style="text-decoration:none"><i class="icon-trash icon-black"></i>&nbsp;Delete</a>
                                                </td>
