...
<script src="<?php echo base_url(); ?>resource/data_table/js/bootstrap-dataTables.js"></script>
                ...
                <div class="col-md-10">
                    ...
                    <div class="form-group has-success">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-hover tableradius" id="example">
                            ...
                            <thead>
                                <tr class="success">
                                    <th width="150">Manual P.ID</th>
                                    <th width="150">Visit No.</th>
                                    <th width="120">Reicv. date</th>
                            ...
                            <tbody>
                                <?php
                                foreach ($view_haematologyreport as $data) {
                                    ?>
    ...
    echo $manual_pid;?></span></td>     <td><?php echo $data->visiting_no; ?></span></td>
