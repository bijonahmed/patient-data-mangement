...
?>
    ...
    <br><br>
    <center><h2>Histopathology Report</h2></center>
    <hr>
    ...
    <div class="">
        <div class="col-md-4">
          ...
          <div class="col-md-3" style="background-color: #d4d4d4; border-radius: 10px;">
              <br>
 ...
 <div class="form-group has-success">
     <input type="text" class="form-control" name="manual_pid" placeholder="Manual Patient ID" id="mpid" autofocus="">
                                </div>
                            <div class="form-group has-success">
