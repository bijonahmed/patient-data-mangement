...
<body>
    ...
    <div class="">
        <div class="">
            <div class="tabbable tabs-left" style="margin-left: 40px;">
                <ul class="nav nav-tabs">
                    ...
                    <li  class="active"><a href="<?php echo base_url(); ?>welcome/physical_findings_info.html" data-toggle="_tab"><div class="glyphicon glyphicon-search"></div>&nbsp;Physical Findings</a></li>
        ...
        <div class="col-md-8">
            <h3>Find Patient Information <font color="red"><strong>[Physical Findings]</strong></font></h3>
            <hr>
            <div class="">
                <form name="conditional_report" class="" method="post" action="<?php echo base_url(); ?>welcome/physical_findings_info.html" target="_top">
                    <div class="form-group has-success">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <input type="text" class="form-control" data-date-format="" id="starting_date_physicalfindings" name="starting_date_physicalfindings" required="1" placeholder="From Date">
                            </div>
                            <div class="col-md-2">
                                <input type="text" class="form-control" data-date-format="" id="ending_date_physicalfindings"name="ending_date_physicalfindings" required="1" placeholder="Ending Date">
                            </div>
                            <div class="col-md-1">
            ...
            <div class="form-group has-success">
                ...
                <?php
                if ($physicalFindingsInfo != null) {
                    ?>

                    <table cellpadding="0" cellspacing="0" border="0" class="table table-hover tableradius" id="example" style="width:950px;">

                        <thead>
                            <tr class="">
                                <th colspan="7" valign="top">    <div align="center">
                            <strong>List OF Physical Findings<font color="red"></font> </strong>
                        ...
                        <tr class="">
                            ...
                            <th width="50">Distolic</th>
                        </tr>
                        </thead>
                        <tbody>
                            <?php
                            foreach ($physicalFindingsInfo as $data) {
                                ?>
                        ...
                        echo $manual_pid;
                                ?></span></td>
                                    ...
                                    <td><?php echo $data->bsa; ?></span></td>
                                    <td><?php echo $data->systolic; ?></span></td>
                                    <td><?php echo $data->diastolic; ?></span></td>
