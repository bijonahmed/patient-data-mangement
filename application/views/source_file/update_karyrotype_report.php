    ...
    <body>
        ...
        <div class="container">
         ...
         <br>
                ...
                <form name="haematology" method="post" action="<?php echo base_url(); ?>data_record/update_karyotype_report.html">
                        ...
                        <div class="">
                            ...
                            <div class="row" style="" >
                                ...
                                <div class="col-xs-2">
                                    ...
                                    <input type="text" name="reciv_date" data-date-format="dd-mm-yyyy" class="form-control" id="reciv_date" value="<?php echo $karyotype_data->reciv_date;?>">
                                    <input type="hidden" name="karyotype_id" data-date-format="dd-mm-yyyy" class="form-control" id="reciv_date" value="<?php echo $karyotype_data->karyotype_id;?>">
                                </div>
                        ...
                        <div class="row" >
                            ...
                            <div class="container">
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <div class="row">
                                        <textarea class="jqte-test form-control" name="report_description"><?php echo $karyotype_data->report_description;?></textarea>
