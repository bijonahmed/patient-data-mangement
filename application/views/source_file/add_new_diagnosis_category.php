...
<html lang="en">
    ...
    <div class="container">
        ...
        <div class="form-group has-success">
            <div class="row">
                <div class="alert alert-info">Add New Diagnosis Category  
               <font color="#FF0000">
                    <?php
                    ...
                    <div class="col-md-3 alert alert-success">
                          <form name="appearnce" method="post" action="<?php echo base_url();?>data_record/save_customized_diagnosis_category.html">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Diagnosis Category </h4>
      </div>
...
<td>
<a class="link" href="<?php echo base_url();?>data_record/edit_form_diagnosis_category/<?php echo $data->diagnosis_category_id;?>" onClick="return sure();" style="text-decoration:none"><span class="glyphicon glyphicon-edit"></span> Edit</a>
