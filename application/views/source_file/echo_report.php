...
<link rel="stylesheet" href="<?php echo base_url(); ?>resource/themes/base/jquery.ui.all.css">
        ...
        <script>
            $(document).ready(function() {
                ...
                var source = '<?php echo base_url(); ?>welcome/print_preview_echo'; 								//Refer to any page on your server, external pages are not valid e.g. http://www.google.co.uk
  ...
  <style>
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <div class="container">
                  <center><div class="fontstyleing"><u>ECHO Report</u></div></center>
       
                <form name="haematology" method="post" action="<?php echo base_url(); ?>data_record/save_echo_report.html">
                    <div class="form-group has-success">
                        ...
                        <div class="row" >
                            ...
                            <div class="container">
                                <font color="#FF0000">
                                <?php
                                $message = $this->session->userdata('save_messages_echo');
                                //echo $message;
                                if (isset($message)) {
                                    echo $message;
                                    $this->session->unset_userdata('save_messages_echo');
                                }
                                ?>
                                </font> 
                                <div class="form-group has-success">
...
<button class="btn btn-primary"onClick="return save()"><span class="glyphicon glyphicon-saved"></span>&nbsp;Save</button>
    ...
    echo $manual_pid;?></span></td>
                                                ...
                                                <td>
                                                    <a class="tooltips link" href="<?php echo base_url(); ?>data_record/edit_form_echo_report/<?php echo $data->echo_id; ?>" onClick="return save();" style="text-decoration:none"><span>Edit Report</span> Edit</a>
                                                    <?php
                                                    /*
