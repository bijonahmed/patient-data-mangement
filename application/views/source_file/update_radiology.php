...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <div class="container">
                <form name="radiology" method="post" action="<?php echo base_url(); ?>data_record/update_radiology_report.html">
                    <div class="form-group has-success">
                        <div class="">
                            ...
                            <div class="row" style="" >
                                ...
                                <div class="col-xs-2">
  <input type="hidden" name="radiology_id" class="form-control" value="<?php echo $radiology_report->radiology_id;?>">
                                    <input type="text" name="reciv_date" data-date-format="dd-mm-yyyy" class="form-control" id="reciv_date" value="<?php echo $radiology_report->reciv_date;?>">
                                </div>
                        ...
                        <div class="row" >
                            ...
                            <div class="container">
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <div class="row">
                                        <textarea class="jqte-test form-control" name="report_description" ><?php echo $radiology_report->report_description;?></textarea>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($radiology_data as $data) {
                                            ...
                                            <tr class="">
                                                ...
                                                <td>
                                                    <a class="link" href="<?php echo base_url(); ?>data_record/edit_form_radiology_report/<?php echo $data->radiology_id; ?>" onClick="return save();" style="text-decoration:none"><span class="glyphicon glyphicon-edit"></span> Edit</a>
                                                    <?php
                                                    /*
