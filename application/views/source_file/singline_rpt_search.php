...
?>
    ...
    <br><br>
    <center><h2>Single Line Report</h2></center>
    <hr>
    ...
    <div class="">
        <div class="col-md-4">
          ...
          <div class="col-md-3" style="background-color:#9966FF; border-radius: 10px;">
              <br>
 ...
 <input type="text" class="form-control" data-date-format="" id="starting_date_usg" name="starting_date_multiple" required="1">
     ...
     <input type="text" class="form-control" data-date-format="" id="ending_date_usg" name="ending_date_multiple" required="1">
                            ...
                            <center><button class="btn btn-default"><span class="glyphicon glyphicon-search"></span> Search</button></center>
