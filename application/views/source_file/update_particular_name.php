  ...
  <body>
      ...
      <div class="row">
          <div class="col-md-2">
           ...
           <div class="col-md-8">
                 <fieldset>
                     <legend><center>Update Particular_by_name</center></legend>
               <div class="">
                   <br>
               <form name="frm" method="post" action="<?php echo base_url();?>data_record/update_add_new_patient_info_by_name.html">
