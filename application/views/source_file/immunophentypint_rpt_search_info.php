    ...
    <body>
        ...
        <div class="">
            <div class="">
                <div class="tabbable tabs-left" style="margin-left: 40px;">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="#" data-toggle="_tab"><div class="glyphicon glyphicon-search"></div>&nbsp;Immunophentotype</a></li>
            ...
            <div class="">
                ...
                <h3>Find Patient Investigation <font color="red"><strong>[Immunophenotyping]</strong></font></h3>
                <hr>
                <div id="">
                    <div class="form-group has-warning">
                        <form class="form-inline" name="p_id" method="post" action="<?php echo base_url(); ?>welcome/patient_find_investigation_immunophentypint.html">
                            <input type="text" class="form-control" name="manual_pid" placeholder="Patient ID" id="TBox0" autofocus="">
                            <input type="text" class="form-control" data-date-format="" id="starting_date" name="starting_date_immunophenotyping" required="1" placeholder="From Date">
                            <input type="text" class="form-control" data-date-format="" id="ending_date" name="ending_date_immunophenotyping" required="1" placeholder="Ending Date">
                    ...
                    <div class="form-group has-success">
                        ...
                        <?php
                        if ($immunophenotyping_rpt_searching != null) {
                            ?>
                            ...
                            <div id="printablediv" style="width: 100%; background-color: none; height: auto">
                                <div align="center">
                                    <strong>Immunophenotype Report Statement<BR><font color="red"></font> </strong>
                                ...
                                <div id="dvData">
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-hover tableradius" id="example_">
                                        ...
                                        <th width="100" valign="top"><div align="left">M. P ID</div></th>
                                        <th width="200" valign="top"><div align="left">Patient Name</div></th>
                                        <th width="100" valign="top"> <div align="left">Date</div></th>
                                        <th width="100" valign="top"> <div align="left">Test Name</div></th>
                                        <th width="100" valign="top"> <div align="left">Value</div></th>
                                        <th width="100" valign="top"> <div align="left">Cell Line</div></th>
                                        <th width="100" valign="top"><div align="left">Others Data</div></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            $x = 1;
                                            foreach ($immunophenotyping_rpt_searching as $data) {
                                                ?>
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td valign="top"><div align="left"><?php echo $data->reciv_date; ?></span></div></td>
                                                    <td valign="top"><div align="left"><?php echo $data->immunophenotype_test_name; ?></span></div></td>
                                                    <td valign="top"><div align="left"><?php echo $data->value; ?></span></div></td>
                                                    <td valign="top"><div align="left"><?php echo $data->cell_line; ?></span></div></td>
                                                    <td valign="top"><div align="left"><?php echo $data->description; ?></span></div></td>
                                                </tr>
                                                <?php
                                                $x++;
                                            }
