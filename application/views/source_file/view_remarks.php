...
<td>
<a class="link" href="<?php echo base_url();?>data_record/edit_form_remarks/<?php echo $data->remarks_id;?>" onClick="return sure_();" style="text-decoration:none"><span class="glyphicon glyphicon-edit"></span> Edit</a>
<a class="link" href="<?php echo base_url();?>data_record/delete_remarks/<?php echo $data->remarks_id;?>" onClick="return sure();" style="text-decoration:none"><span class="glyphicon glyphicon-trash"></span> Delete</a>
