...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <div class="container">
                <form name="haematology" method="post" action="<?php echo base_url(); ?>data_record/update_usg_report.html">
                        ...
                        <div class="">
                            ...
                            <div class="row" style="">
                                ...
                                <div class="col-xs-2">
                                    ...
                                    <input type="text" name="reciv_date" data-date-format="dd-mm-yyyy" class="form-control" id="reciv_date" placeholder="Reci.Date" value="<?php echo $usg_report->reciv_date;?>">
                                    <input type="hidden" name="usg_id" class="form-control"  value="<?php echo $usg_report->usg_id;?>">
                                </div>
                        ...
                        <div class="row" >
                            ...
                            <div class="container">
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <div class="row">
                                        <textarea class="jqte-test form-control" name="report_description"><?php echo $usg_report->report_description;?></textarea>
