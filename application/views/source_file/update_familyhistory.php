...
<ul class="nav nav-tabs">
  ...
  <li class="active"><a href="#home" data-toggle="tab">Family History</a></li>
      ...
      <div class="row">
         ...
         <div class="">
             <br>
              ...
              <!-- Tab panes -->
<form name="myform" method="post" action="<?php echo base_url(); ?>data_record/update_patieint_history_info_by_familyhistory.html">
  
<div class="tab-content">
    <div class="tab-pane active" id="home">
        <br>
        <div class="row">
            <div class="col-md-3">Update Family History</div> 
            <div class="col-md-4">
...
<input type="hidden" name="family_history_id" value="<?php echo $familyHistory->family_history_id;?>">
