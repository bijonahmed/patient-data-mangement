...
<td>
<a class="link" href="<?php echo base_url();?>data_record/edit_form_phy_fin_value/<?php echo $data->phy_fin_value_Id;?>" onClick="return sure();" style="text-decoration:none"><span class="glyphicon glyphicon-edit"></span> Edit</a>
