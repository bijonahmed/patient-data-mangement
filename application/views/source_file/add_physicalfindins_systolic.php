...
<html lang="en">
    ...
    <div class="container">
        ...
        <div class="form-group has-success">
            <div class="row">
                <div class="alert alert-info">Add Customize Systolic Data  
               <font color="#FF0000">
                    <?php
                    ...
                    <div class="col-md-3 alert alert-success">
                          <form name="systolic" method="post" action="<?php echo base_url();?>data_record/save_customized_physical_fidings_systolic.html">
               ...
               <div class="col-md-3">
                ...
                <form name="appearnce" method="post" action="<?php echo base_url();?>data_record/save_customized_physical_fidings_systolic_info_save.html">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Physical Findings Systolic</h4>
      </div>
...
<td>
<a class="link" href="<?php echo base_url();?>data_record/edit_form_systolic_heading/<?php echo $data->custom_phy_findings_systolic_id;?>" onClick="return sure();" style="text-decoration:none"><span class="glyphicon glyphicon-edit"></span> Edit</a>
...
<div class="modal fade" id="value" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalLabel">Systolic Value</h4>
      </div>
      <div class="modal-body">
<div class="form-group has-success">
    <br>
...
foreach($view_systolic_value as $data) {
?>


<tr class="">
    <td><?php echo $data->customized_physical_findings_systolic_name;?></span></td>
       <td><?php echo $data->phy_fin_value_systolic;?></span></td>


<td>
<a class="link" href="<?php echo base_url();?>data_record/edit_form_phy_fin_value/<?php echo $data->phy_fin_systolic_id;?>" onClick="return sure();" style="text-decoration:none"><span class="glyphicon glyphicon-edit"></span> Edit</a>
