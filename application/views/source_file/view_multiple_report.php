...
<script src="<?php echo base_url(); ?>resource/data_table/js/bootstrap-dataTables.js"></script>
                ...
                <div class="col-md-10">
                    ...
                    <div class="form-group has-success">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-hover tableradius" id="example">
                            ...
                            <tbody>
                                <?php
                                foreach ($view_multiple_report as $data) {
                                    ?>
    ...
    echo $manual_pid;?></span></td>
                                        ...
                                        <td><?php echo $data->result; ?></span></td>
                                       
                                       

   <td>

                                            <a class="link" href="<?php echo base_url();?>data_record/edit_form_multiple_rpt/<?php echo $data->multiple_report_id;?>" onClick="return save_();" style="text-decoration:none"><span class="glyphicon glyphicon-edit"></span> Edit</a>
                                            <a class="link" href="<?php echo base_url();?>data_record/delete_multiple_rpt/<?php echo $data->multiple_report_id;?>" onClick="return save();" style="text-decoration:none"><span class="glyphicon glyphicon-trash"></span> Delete</a>
