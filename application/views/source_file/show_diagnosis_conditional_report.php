 ...
 <script language="javascript" type="text/javascript">
    ...
    <body>  <br><br><br>
        <div class="container">
            ...
            <div align="center">
                <strong>List OF Diagnosis<br><font color="red"><?php if(isset($diagnosis_information_byPT)) echo $diagnosis_information_byPT;?></font> </strong>
