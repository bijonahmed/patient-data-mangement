...
<html lang="en">
    ...
    <div class="container">
        ...
        <div class="form-group has-success">
            <div class="row">
                <div class="alert alert-info">Update Customize Physical Findings Data    <font color="#FF0000">
                    <?php
                ...
                <form name="appearnce" method="post" action="<?php echo base_url();?>data_record/update_customized_physical_fidings_value.html">
                    <div class="col-md-3 alert alert-info">
                    <select name="custom_phy_findings_id" class="form-control sm">
                    <option value=""><?php echo $updatephyfinInfo_value->customized_physical_findings_name;?></option>
...
foreach ($view_physicafindings as $data) {
    ?>
                        ...
                        <br>
                        <input type="text" class="form-control" id="inputSuccess1" name="phy_fin_value" value="<?php echo $phyfinInfo_value->phy_fin_value;?>">
                        <input type="hidden" class="form-control" id="inputSuccess1" name="phy_fin_value_Id" value="<?php echo $phyfinInfo_value->phy_fin_value_Id;?>"><br>
                        <br>
                        <center>                    
