...
<html lang="en">
    ...
    <div class="container">
        <div align="right"> <a href="<?php echo base_url()?>welcome/cytogenetic_report.html">
                    <button class="btn btn-danger">Close</button>  </a> </div>
        <div class="form-group has-success">
            <div class="row">
                <div class="alert alert-info">Add New Cytogenetic Test Name 
               <font color="#FF0000">
                    <?php
                    ...
                    <div class="col-md-3 alert alert-success">
                          <form name="cytogenetic" method="post" action="<?php echo base_url();?>data_record/save_cytogenetic_testName.html">
                        <input type="text" class="form-control" name="cytogenetic_test_name" id="inputSuccess1" placeholder="Cytogenetic Test Name" required="1"><br>
                        <center>                    
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Cytogenetic Test Name </h4>
      </div>
...
foreach($cytogenetic_name as $data) {
?>

<tr class="">
    <td><?php echo $data->cytogenetic_test_name;?></span></td>


<td>
<a class="link" href="<?php echo base_url();?>data_record/edit_form_cytogenetic_test_name/<?php echo $data->cytogenetic_test_name_id;?>" onClick="return sure();" style="text-decoration:none"><span class="glyphicon glyphicon-edit"></span> Edit</a>
