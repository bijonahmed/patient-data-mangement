...
<li><a href="<?php echo base_url();?>welcome/patient_find_investigation_bone_marrow.html" data-toggle="_tab"><div class="glyphicon glyphicon-search"></div>&nbsp;Bone Marrow</a></li>
 <li  class="active"><a href="#" data-toggle="_tab"><div class="glyphicon glyphicon-search"></div>&nbsp;Radiology</a></li>
<li><a href="<?php echo base_url();?>welcome/patient_find_investigation_ultrasonography.html" data-toggle="_tab"><div class="glyphicon glyphicon-search"></div>&nbsp;Ultrasonography</a></li>
 ...
 <li><a href="<?php echo base_url();?>welcome/patient_find_investigation_echo.html" data-toggle="_tab"><div class="glyphicon glyphicon-search"></div>&nbsp;Echo</a></li>
        ...
        <h3>Find Patient Investigation <font color="red"><strong>[Radiology]</strong></font></h3>
         <hr>
            <div id="">
            <div class="form-group has-warning">
              <form class="form-inline" name="p_id" method="post" action="<?php echo base_url();?>welcome/patient_find_investigation_radiology.html">
                <input type="text" class="form-control" name="manual_pid" placeholder="Manual Patient ID" id="TBox0" autofocus="">
                <input type="text" class="form-control" data-date-format="" id="starting_date" name="starting_date_radiology" required="1" placeholder="From Date">
              <input type="text" class="form-control" data-date-format="" id="ending_date" name="ending_date_radiology" required="1" placeholder="Ending Date">
   ...
   <div class="content" id="main_content" style="display: none; width: 900px;">
            ...
            <?php
            if($radiology_rpt_searching!=null){
            ?>
    ...
    <div align="center">
        <strong>Radiology Statement<BR><font color="red"></font> </strong>
       From <?php echo $date_from;?> To <?php echo $date_to;?>
        ...
        <div id="dvData">
             ...
             <?php
$x=1;
foreach($radiology_rpt_searching as $data) {
?>  
 ...
 <br><br><br>
 <hr>
  <strong><u><font color="#000000">Patient ID: <?php   $length=strlen($data->manual_pid); 
    ...
    echo $manual_pid;?></font></u></strong><br><br>
...
<br>
 ...
 <p align="left"><span class=""> <?php echo $data->report_description;?></span></p>
