...
// foreach($patientComplain as $valueComplain){
         ...
         <br>
                ...
                <form name="haematology" method="post" action="<?php echo base_url(); ?>data_record/update_cytopathology_report.html">
                        ...
                        <div class="">
                            ...
                            <div class="row" style="" >
                                ...
                                <div class="col-xs-2">
                                    ...
                                    <input type="text" name="reciv_date" data-date-format="dd-mm-yyyy" class="form-control" id="reciv_date" value="<?php echo $cytopathology_data->reciv_date;?>">
                                    <input type="hidden" name="cytopathology_id" data-date-format="dd-mm-yyyy" class="form-control" id="reciv_date" value="<?php echo $cytopathology_data->cytopathology_id;?>">
                                </div>
                        ...
                        <div class="row" >
                            ...
                            <div class="container">
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <div class="row">
                                        <textarea class="jqte-test form-control" name="report_description"><?php echo $cytopathology_data->report_description;?></textarea>
