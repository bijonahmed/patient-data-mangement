...
<td>
<a class="link" href="<?php echo base_url();?>data_record/edit_formphysicalfindings/<?php echo $data->custom_phy_findings_id;?>" onClick="return sure_();" style="text-decoration:none"><span class="glyphicon glyphicon-edit"></span> Edit</a>
