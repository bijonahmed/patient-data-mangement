...
<html lang="en">
    ...
    <br><br><br>
      ...
      .margintopinfo
      {
        ...
        <div class="container">
            <div align="right">
                  <a href="<?php echo base_url(); ?>welcome/viewdoes_scheduleName.html">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="margintopinfo">
                        <form name="employee" method="post" action="<?php echo base_url(); ?>data_record/save_doseschedule_name.html">
