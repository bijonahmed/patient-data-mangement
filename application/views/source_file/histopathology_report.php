...
<link rel="stylesheet" href="<?php echo base_url(); ?>resource/themes/base/jquery.ui.all.css">
        ...
        <script>
            $(document).ready(function() {
                ...
                var source = '<?php echo base_url(); ?>welcome/print_preview_histopathology'; 								//Refer to any page on your server, external pages are not valid e.g. http://www.google.co.uk
        ...
        <script>
            $(document).ready(function() {
                $(".btnPrint").printPage({
                    url: "<?php echo base_url(); ?>welcome/print_preview_histopathology.html",
                    attr: "href",
  ...
  <style>
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <div class="container">
                         <center><div class="fontstyleing"><u>Histopathology Report</u></div></center>
        
                <form name="haematology" method="post" action="<?php echo base_url(); ?>data_record/save_histopathology_report.html">
                    <div class="form-group has-success">
                        <div class="">
                            ...
                            <div class="row" style="" >
                                ...
                                <div class="col-xs-2">
                                    ...
                                    <input type="text" name="reciv_date" data-date-format="dd-mm-yyyy" class="form-control" id="reciv_date" placeholder="Please Enter Date">
                                </div>
                        ...
                        <div class="row" >
                            ...
                            <div class="container">
                                <font color="#FF0000">
                                <?php
                                $message = $this->session->userdata('save_messages_histo');
                                //echo $message;
                                if (isset($message)) {
                                    echo $message;
                                    $this->session->unset_userdata('save_messages_histo');
                                }
                                ?>
                                </font> 
                                <div class="form-group has-success">
                                    ...
                                    <div class="row">
                                        <textarea class="jqte-test form-control" name="report_description" ></textarea>
...
<a href="link" data-toggle="modal" data-target="#search" class="btn btn-primary"><span class="glyphicon glyphicon-search"></span>&nbsp;Search</a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Search Histopathology Report</h4>
                    </div>
                        ...
                        <div class="">
                            ...
                            <div class="form-group has-success">
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                    ...
                                    <tbody>
                                        <?php
                                        foreach ($histopathology_report_data as $data) {
                                            ?>
 ...
 <td><?php echo $data->display; ?></span></td>
                                                <td>
                                                    <a class="link" href="<?php echo base_url(); ?>data_record/edit_form_histopathology_report/<?php echo $data->histopathology_id; ?>" onClick="return save();" style="text-decoration:none"><span class="glyphicon glyphicon-edit"></span> Edit</a>
                                                    <?php
                                                    /*
