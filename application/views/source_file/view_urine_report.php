                ...
                <div class="col-md-10">
                    ...
                    <div class="form-group has-success">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-hover tableradius" id="example">
                            ...
                            <tbody>
                                <?php
                                foreach ($view_urine_report as $data) {
                                    ?>
...
<td>
                                            ...
                                            <a class="link" href="<?php echo base_url();?>data_record/edit_form_haematology/<?php echo $data->urine_id;?>" onClick="return save();" style="text-decoration:none"><span class="glyphicon glyphicon-edit"></span> Edit</a>
