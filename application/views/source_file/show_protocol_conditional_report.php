...
<tr class="success">
    ...
    <th width="200">Manual P.ID</th>
<th width="300">Patient Name</th>
<th width="300">Protocol</th>
...
<td><a href="<?php echo base_url();?><?php echo $data->file_upload;?>"><button class="btn btn-danger"><span class="glyphicon glyphicon-download"></span>&nbsp;Download</button></a></span></td>
