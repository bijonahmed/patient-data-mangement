...
<link rel="stylesheet" href="<?php echo base_url(); ?>resource/themes/base/jquery.ui.all.css">
        ...
        <script>
            $(document).ready(function() {
                ...
                var source = '<?php echo base_url(); ?>welcome/print_preview_bonemarrow'; 								//Refer to any page on your server, external pages are not valid e.g. http://www.google.co.uk
        ...
        <script>
            $(document).ready(function() {
                $(".btnPrint").printPage({
                    url: "<?php echo base_url(); ?>welcome/print_preview_bonemarrow.html",
                    attr: "href",
  ...
  <style>
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <div class="container">
                      <center><div class="fontstyleing"><u>Bone Marrow Report</u></div></center>
         
                <form name="haematology" method="post" action="<?php echo base_url(); ?>data_record/save_bonemarrow_report.html">
...
<input type="text" name="introudction" class="form-control" placeholder="Indication" value="">
<br>
<input type="text" name="aspiration" class="form-control" placeholder="Site of aspiration" value="">
 <br>
<input type="text" name="stain_used" class="form-control" placeholder="Stain used" value="">
 <br>
<input type="text" name="cellularity_inf" class="form-control" placeholder="Cellularity" value="">
 <br>
<input type="text" name="meratio" class="form-control" placeholder=" M:E ratio" value="">
<br>
 <input type="text" name="ery" class="form-control" placeholder="Erythropoiesis" value="">
<br>
 <input type="text" name="granu" class="form-control" placeholder="Granulopoiesis" value="">
<br>
 <input type="text" name="mega" class="form-control" placeholder="Megakaryocytes" value="">
 <br>
 <textarea name="ly_his_pls_cells" class="form-control" placeholder="Lymphocytes, histiocytes and plasma cells" ></textarea>

</div>
<div class="col-md-5">


 <input type="text" name="parasites" class="form-control" placeholder="Parasites">
<br>
 <input type="text" name="others" class="form-control" placeholder="Others" >
 <br>
 <input type="text" name="special_stain" class="form-control" placeholder="Special stain" >
 <br>
 <input type="text" name="comment" class="form-control" placeholder="Comment" >
 <br>
 <input type="text" name="test_to_follow" class="form-control" placeholder="Further tests to follow:" v>
<br>
<input type="text" name="reviewed_by" class="form-control"><br>
   <textarea class="form-control" id="ck_editor_" name="report_description" placeholder="Extra Report"></textarea>
</div>
...
<a href="link" data-toggle="modal" data-target="#search" class="btn btn-primary"><span class="glyphicon glyphicon-search"></span>&nbsp;Search</a>
                        ...
                        <div class="">
                            ...
                            <div class="form-group has-success">
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                    ...
                                    <tbody>
                                        <?php
                                        foreach ($bonemarrow_data as $data) {
                                            ?>
 ...
 <td><?php echo $data->display; ?></span></td>
                                                <td>
                                                    <a class="tooltips link" href="<?php echo base_url(); ?>data_record/edit_form_bonemarrow_report/<?php echo $data->bonemarrow_id; ?>" onClick="return save();" style="text-decoration:none"><span>Edit Report</span> Edit</a>
                                                    <?php
                                                    /*
