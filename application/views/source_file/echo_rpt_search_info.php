    ...
    <body>
        ...
        <div class="">
            <div class="">
                <div class="tabbable tabs-left" style="margin-left: 40px;">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="#" data-toggle="_tab"><div class="glyphicon glyphicon-search"></div>&nbsp;Echo</a></li>
            ...
            <div class="">
                ...
                <h3>Find Patient Investigation <font color="red"><strong>[Echo]</strong></font></h3>
                <hr>
                <div id="">
                    <div class="form-group has-warning">
                        <form class="form-inline" name="p_id" method="post" action="<?php echo base_url(); ?>welcome/patient_find_investigation_echo.html">
                            <input type="text" class="form-control" name="manual_pid" placeholder="Patient ID" id="TBox0" autofocus="">

                            <input type="text" class="form-control" data-date-format="" id="starting_date" name="starting_date_echo" required="1" placeholder="From Date">

                            <input type="text" class="form-control" data-date-format="" id="ending_date"name="ending_date_echo" required="1"  placeholder="Ending Date">
                    ...
                    <div class="form-group has-success">
                        ...
                        if ($echo_rpt_searching != null) {
                            ...
                            <div id="printablediv" style="width: 100%; background-color: none; height: auto">
                                <div align="center">
                                    <strong>ECHO Report<BR><font color="red"></font> </strong>
