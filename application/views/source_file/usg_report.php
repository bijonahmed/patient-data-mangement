...
<html lang="en">
    <head>
        ...
        <script>
            $(document).ready(function() {
                ...
                var source = '<?php echo base_url(); ?>welcome/ultrasonography_report'; 								//Refer to any page on your server, external pages are not valid e.g. http://www.google.co.uk
        ...
        <script>
            $(document).ready(function() {
                $(".btnPrint").printPage({
                    url: "<?php echo base_url(); ?>welcome/ultrasonography_report.html",
                    attr: "href",
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <div class="container">
                <center><div class="fontstyleing"><u>Ultrasonography Report</u></div></center>

                <form name="haematology" method="post" action="<?php echo base_url(); ?>data_record/save_usg_report.html">
                    ...
                    <center>
                        <button class="btn btn-primary"><span class="glyphicon glyphicon-saved"></span>&nbsp;Save</button>
                        <?php
                        /*
...
foreach ($usg_data as $data) {
    ...
    ?></span></td>
                                        ...
                                        <td><?php echo $data->display; ?></span></td>
                                                <td>
                                                    <a class="tooltips link" href="<?php echo base_url(); ?>data_record/edit_form_usg_report/<?php echo $data->usg_id; ?>" style="text-decoration:none"><span>Edit Usg Report</span> Edit</a>
    <?php
    /*
