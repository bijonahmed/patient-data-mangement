...
?>
    ...
    <br><br>
    <center><h2>Sex Searching</h2></center>
    <hr>
    ...
    <div class="">
        <div class="col-md-4">
          ...
          <div class="col-md-3" style="background-color: #6666FF; border-radius: 10px;">
              <br>
              <form name="conditional_report" method="post" action="<?php echo base_url(); ?>data_record/preview_date_wise_statment_sex_searching.html" target="_top">
                            ...
                            <div class="form-group has-success">
                                ...
                                <font color="white">Starting Date</font><div class="form-group has-success">
                                    <input type="text" class="form-control" data-date-format="" id="starting_date_sex" name="starting_date_sex" required="1">
                                </div>

                                <font color="white">  Ending Date</font><div class="form-group has-success">
                                    <input type="text" class="form-control" data-date-format="" id="ending_date_sex"name="ending_date_sex" required="1">
                                </div>
