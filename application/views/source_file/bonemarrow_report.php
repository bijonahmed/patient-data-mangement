...
Date : <?php echo $this->session->userdata('reciv_date')?><br>
 ...
 <hr> 
   ...
   <p align="left"><span class="style70"> <?php echo $this->session->userdata('introudction')?></span></p>
  <p align="left"><span class="style70"> <?php echo $this->session->userdata('aspiration')?></span></p>
  <p align="left"><span class="style70"> <?php echo $this->session->userdata('stain_used')?></span></p>
  <p align="left"><span class="style70"> <?php echo $this->session->userdata('cellularity_inf')?></span></p>
  <p align="left"><span class="style70"> <?php echo $this->session->userdata('meratio')?></span></p>
  
    <p align="left"><span class="style70"> <?php echo $this->session->userdata('ery')?></span></p>
  <p align="left"><span class="style70"> <?php echo $this->session->userdata('granu')?></span></p>
  <p align="left"><span class="style70"> <?php echo $this->session->userdata('mega')?></span></p>
  <p align="left"><span class="style70"> <?php echo $this->session->userdata('ly_his_pls_cells')?></span></p>
  <p align="left"><span class="style70"> <?php echo $this->session->userdata('parasites')?></span></p>
  
   <p align="left"><span class="style70"> <?php echo $this->session->userdata('others')?></span></p>
  <p align="left"><span class="style70"> <?php echo $this->session->userdata('special_stain')?></span></p>
  <p align="left"><span class="style70"> <strong><?php echo $this->session->userdata('comment')?></strong></span></p>
  <p align="left"><span class="style70"> <?php echo $this->session->userdata('test_to_follow')?></span></p>
  <p align="left"><span class="style70"> <?php echo $this->session->userdata('reviewed_by')?></span></p>
