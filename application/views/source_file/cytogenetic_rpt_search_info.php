    ...
    <body>
        ...
        <div class="">
            <div class="">
                <div class="tabbable tabs-left" style="margin-left: 40px;">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="#" data-toggle="_tab"><div class="glyphicon glyphicon-search"></div>&nbsp;Cytogenetic</a></li>
            ...
            <div class="">
                ...
                <h3>Find Patient Investigation <font color="red"><strong>[Cytogenetic]</strong></font></h3>
                <hr>
                <div id="">
                    <div class="form-group has-warning">
                        <form class="form-inline" name="p_id" method="post" action="<?php echo base_url(); ?>welcome/patient_find_investigation_cytogenetic.html">
                            <input type="text" class="form-control" name="manual_pid" placeholder="Patient ID" id="TBox0" autofocus="">
                            <input type="text" class="form-control" data-date-format="" id="starting_date_cytogenetic" name="starting_date_cytogenetic" required="1" placeholder="From Date">
                            <input type="text" class="form-control" data-date-format="" id="ending_date" name="ending_date_cytogenetic" required="1" placeholder="Ending Date">
                    ...
                    <div class="form-group has-success">
                        ...
                        <?php
                        if ($cytogenetic_rpt_searching != null) {
                            ?>
                            ...
                            <div id="printablediv" style=" width: 1000px; background-color: none; height: auto">
                                ...
                                <div id="dvData">
                                    ...
                                    foreach ($cytogenetic_rpt_searching as $data) {
                                        ...
                                        <hr>
                                        <strong><font color="#000000">Patient ID: <?php
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0" class="table" id="example_">
                                            <thead>
                                                <tr>
                                                    <th width="77"><div align="left">SL NO</div></th>
                                            <th width="172"><div align="left">Test Name</div></th>

                                            <th width="106">Result</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><div align="center"><?php echo $data->result; ?> </div></td>
