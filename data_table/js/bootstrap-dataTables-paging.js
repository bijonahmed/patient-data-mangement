...
$.extend(true, $.fn.dataTable.defaults, {
  "sDom": "<'row'<'col-xs-10 col-lg-10'7><'col-xs-7 col-sm-6 text-right'f>r>t<'row'<'col-xs-3 col-sm-4 col-md-10'i><'col-xl-3 col-sm-4 col-md-10 text-right'p>>",
  ...
  "fnInitComplete": function (oSettings, json) {
    ...
    if (currentId) {
      ...
      thisFilterLabel.addClass('control-label col-xs-4 col-sm-3 col-md-6').attr('for', currentId + '_filter_input');
      thisFilterInput.addClass('form-control input-sm').attr('id', currentId + '_filter_input');
      thisFilterInput.appendTo(thisFilter).wrap('<div class="col-xs-8 col-sm-9 col-md-6 " />');
    }
  }
});
